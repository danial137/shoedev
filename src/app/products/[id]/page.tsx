        ...
        <div className='flex flex-col gap-4 lg:flex-row md:gap-12 mt-12'>
            ...
            <div className="w-full lg:w-7/12 flex flex-col gap-4">
                ...
                <p className="text-gray-500 text-xs">
                    By clicking pay now youn agree to our {""}
                    <span className="underline hover:text-black"> terms and conditions</span>{""}
                    and <span className="underline hover:text-black"> privacy policy</span>
                    you authorize us to charge your card for the total amount at checkout.
                    total amount includes taxes and shipping fees.{""}
