            ...
            <div className="w-full flex flex-col lg:flex-row gap-16 ">
                ...
                <div className="w-full lg:w-7/12 shadow-lg border-1 border-gray-100 rounded-lg p-8 flex flex-col gap-8 h-max">
                    {activeStep === 1 ? (cart.map(item => (
                        <div className="flex items-center justify-between pb-4" key={item.id+item.selectedSize+item.selectedColor}>
                            {/* images */}
                            ...
                            {/* delete button */}
                            <button  onClick={()=>removeFromCart(item.id)} className="w-8 h-8 rounded-full bg-red-100 hover:bg-red-200 transition-all duration-300 text-red-400 flex items-center justify-center cursor-pointer ">
