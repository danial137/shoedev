        ...
        <div className='flex flex-col gap-4 mt-4'>
            ...
            <div className="flex flex-col gap-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                    {product.colors.map(color => (
                        ...
                        <div className={`cursor-pointer border-1  p-[2px] ${selectedColor === color ? "border-gray-300" : "border-white"}`} key={color} onClick={() => handleTypeChange("color", color)}>
            ...
            <div className="flex flex-col gap-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span>{quantity}</span>
                    <button className="cursor-pointer border-1 border-gray-300 p-[2px]" onClick={() => handleQuantityChange("increment")}>
